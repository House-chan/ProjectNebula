...
class EnemyManager(object):
	def __init__(self):
		...
		rs=globe.mgame.rsmanager.anime
		entype={}
		for i in range(8):
			tp="sprite"+str(i)
			anime={}
			anime["stay"]=rs["enemy"][i][0]
			anime["toright"]=rs["enemy"][i][1]
			anime["right"]=rs["enemy"][i][2]
			anime["toleft"]=rs["enemy"][i][3]
			anime["left"]=rs["enemy"][i][4]
		...
		anime={}
		anime["stay"]=rs["cirno"][0]
		anime["toleft"]=rs["cirno"][1]
		anime["toright"]=rs["cirno"][2]
